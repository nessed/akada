...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        // --font-serif resolves to Fraunces (see :root in globals.css); the
        // rest come straight from the next/font variables layout.tsx puts on
        // <html>. font-hand is marginalia only.
